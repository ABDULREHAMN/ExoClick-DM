// Centralized, append-only data source for all historical reports
// This is the single source of truth - new data is always appended, never overwritten
...
// All historical data - append only
